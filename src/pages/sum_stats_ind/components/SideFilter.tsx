...
import { bandwidthDivisorMarks, binMarks, datasets, FilterState, mapJitMarks, mappingToShort, mppMarks, optionsAll, optionsAncestry, optionsAxis, optionsChromosome, optionsContinuous, optionsDiscrete, optionsRegion, tdBandwidthDivisorMarks, tdThresholdDivisorMarks } from "@/pages/sum_stats_ind/static/ssiStatic";
              ...
              <FormControl fullWidth sx={{ mb: 1 }}>
                ...
                >
                  {filters.plot === "Density"
                    ? optionsContinuous.map((option, index) => (
